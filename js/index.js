        ...
        createPcsList: function () {
            ...
            customAjax.AjaxGet(url, data, function (res) {
                if (res.result.length > 0) {
                    ...
                    $('.gsphPanel').children('.phbTitle').find('p:last-child').text(moment().format('YYYY-MM'))
                }
            })
        },
        // 各村（居）排行
        createGcjphList: function () {
            ...
            customAjax.AjaxGet(url, data, function (res) {
                if (res.result.length > 0) {
                    ...
                    $('.gcjphPanel').children('.phbTitle').find('p:last-child').text(moment().format('YYYY-MM'))
        ...
        createCjphList: function () {
            ...
            customAjax.AjaxGet(url, data, function (res) {
                if (res.result.records.length > 0) {
                    ...
                    $('.cjphPanel').children('.phbTitle').find('p:last-child').text(moment().format('YYYY-MM'))
